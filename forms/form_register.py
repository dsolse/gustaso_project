...
class RegisterForm(FlaskForm):
	...
	name = StringField("Nombre del guapo", validators=[InputRequired(), Length(min=3, max=20)], render_kw={"placeholder" : "Escribe el nombre del guapo"})
	...
	soltero = SelectField("Eres soltero", choices= [("1", "Si"), ("2", "No")], validators=[InputRequired()])
